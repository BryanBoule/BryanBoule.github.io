...
Mon travail se situe à l'intersection de la vision par ordinateur, de la validation clinique, et de la régulation des dispositifs médicaux. Je me soucie de construire des systèmes qui ne soient pas seulement state-of-the-art techniquement, mais cliniquement sûrs et regulatory-proof.
...
Before HUVY, I built expertise in image processing and machine learning applied to many domains.`,
  ...
  huvy: {
    ...
    role: { fr: 'Co-fondateur & CTO', en: 'Co-founder & CTO' } as Localized,
    since: 'sept. 2021',
    tech: ['Computer Vision', 'PyTorch', 'CE Class IIb', 'Clinical Validation', 'MLOps', 'DICOM', 'Edge inference'],
    impact: [
      { fr: 'Dispositif médical certifié CE Classe IIb', en: 'CE Class IIb certified medical device', metric: 'CE IIb' },
      { fr: 'Brevet — détection du mélanome par IA', en: 'Patent — melanoma detection by AI', metric: 'Patent' },
      { fr: "Mélanome : l'un des cancers les plus évitables si détecté tôt", en: 'Melanoma: one of the most preventable cancers when caught early', metric: '90%+' },
  ...
  skills: {
    ...
    groups: [
      { label: { fr: 'IA & Vision', en: 'AI & Vision' }, items: ['Computer Vision', 'Deep Learning', 'PyTorch', 'TensorFlow', 'OCR', 'NLP / BERT', 'Reinforcement Learning'] },
      { label: { fr: 'Medtech / Régulation', en: 'Medtech / Regulation' }, items: ['SaMD', 'CE Class IIb', 'Clinical Validation', 'ISO 13485', 'GDPR', 'DICOM'] },
      { label: { fr: 'Ingénierie', en: 'Engineering' }, items: ['Python', 'CUDA / OpenMP', 'CI/CD', 'MLOps', 'REST APIs', 'Data Lakes'] },
      { label: { fr: 'Leadership', en: 'Leadership' }, items: ['AI Product Strategy', 'Team Building', 'Mentorat', 'Workshops'] },
    ] as SkillGroup[],
  },
  ...
  education: {
    ...
    items: [
      { school: 'ENSAE ParisTech', degree: { fr: 'MSc Data Science — Math. & Statistiques', en: 'MSc Data Science — Math. & Statistics' }, period: '2018 — 2019' },
      { school: 'Télécom SudParis', degree: { fr: 'Ingénieur — Math. & Statistiques Appliquées', en: 'Engineering — Applied Math. & Statistics' }, period: '2015 — 2018' },
